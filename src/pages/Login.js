  ...
  return (
    <DefaultContainer>
      <div className="w-full max-w-[400px] m-auto">
        ...
        <PasswordInput placeholder="Password" type="password" password />
        ...
        <div className="flex items-center justify-center mt-[10px] text-grey">Don't have an account yet? <ButtonLink href="/" className="ml-[10px]">Register now</ButtonLink></div>
      </div>
    </DefaultContainer>
  )
}
